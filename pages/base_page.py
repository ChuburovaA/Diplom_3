...
class BasePage:
    ...
    def find_element(self, locator):
        return self.wait_visibility_element(locator)
    ...
    def click_to_visible_element(self, locator):
        self.wait_visibility_element(locator).click()
    ...
    def check_invisibility(self, locator):
        return WebDriverWait(self.driver, 20).until(EC.invisibility_of_element(locator))
